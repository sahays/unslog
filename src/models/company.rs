...
/// Target company. Canonical store is Postgres (`companies` table).
/// `research_packet` is JSONB on the Postgres side.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct Company {
    pub id: String,
    ...
    pub role: String,
    /// Canonical role bucket — drives cross-company question pooling.
